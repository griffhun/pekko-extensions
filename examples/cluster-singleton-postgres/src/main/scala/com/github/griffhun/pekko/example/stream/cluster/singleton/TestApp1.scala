...
object TestApp1 extends App with StrictLogging {
  val system = ClassicActorSystem("TestApp", ConfigFactory.load("application-1.conf"))
  ...
  val sourceFactory = () =>
    Source
      ...
      .take(1000)
  ClusterSingletonStream(sourceFactory, sharedKillSwitch): Unit
